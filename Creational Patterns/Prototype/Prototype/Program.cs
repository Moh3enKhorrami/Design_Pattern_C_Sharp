...
public class Program
{
    private static void Main(string[] args)
    {
        ...
        DisplayValues(p2);
        System.Console.WriteLine("p3 instance values:");
        DisplayValues(p3);
        ...
        System.Console.WriteLine("p1 instance values: ");
        DisplayValues(p1);
        System.Console.WriteLine("p2 instance values (reference values have changed):");
        DisplayValues(p2);
        System.Console.WriteLine("p3 instance values (everything was kept the same):");
        DisplayValues(p3);
